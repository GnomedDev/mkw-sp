...
static_assert_32bit(sizeof(RaceConfigPlayer) == 0xf0);
...
static_assert_32bit(sizeof(RaceConfigScenario) == 0xbf0);
...
static_assert_32bit(offsetof(RaceConfig, ghostBuffers[0][2]) == 0x73f0);
